...
|------------------------------------|:--------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| INCLUDE_TAGS_FOR_ALL_OCIDS         |                        True                        | If `True`, tags for all OCIDs within the event payload will be added.  If `False`, the list of `TARGET_OCID_KEYS` will be used.                                                                                                                                                                                                                                                                                                                                                                                                      |
| TARGET_OCID_KEYS                   | compartmentId vcnId subnetId vnicId vnicsubnetocid | This parameter is only evaluated when `INCLUDE_TAGS_FOR_ALL_OCIDS` is `False`.  Simply provide a space-separated list of OCID keys (l-values) in the JSON.  The tags for each will be retrieved and added.                                                                                                                                                                                                                                                                                                                           |
| TARGET_OCID_KEYS_WARN_IF_NOT_FOUND |                       False                        | This parameter is only evaluated when `INCLUDE_TAGS_FOR_ALL_OCIDS` is `False`.  Default of `False` suppresses log warnings when a key contained in `TARGET_OCID_KEYS` is not found in the event payload.                                                                                                                                                                                                                                                                                                                             |
| INCLUDE_FREEFORM_TAGS              |                        True                        | Determines whether `'freeform'` tag types should be included.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| INCLUDE_DEFINED_TAGS               |                        True                        | Determines whether `'defined'` tag types should be included.                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| INCLUDE_SYSTEM_TAGS                |                        True                        | Determines whether `'system'` tag types should be included.                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| INCLUDE_EMPTY_TAGS                 |                       False                        | Determines whether empty tag dictionaries will be emitted for `'freeform'`, `'defined'` or `'system'` tag types when there are no tags of that type.                                                                                                                                                                                                                                                                                                                                                                                 |
